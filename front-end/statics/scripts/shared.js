...
(function () {
  ...
  function showToast(message, type) {
    ...
    toast.innerHTML =
      ...
      '<button type="button" class="toast-close" aria-label="بستن">&times;</button>';
  ...
  // Render Django messages on page load
  document.addEventListener('DOMContentLoaded', function () {
    var msgEls = document.querySelectorAll('.django-messages .toast-data');
    msgEls.forEach(function (el) {
      showToast(el.textContent, el.getAttribute('data-level') || 'info');
    });
    // Remove the hidden container after rendering
    var msgContainer = document.querySelector('.django-messages');
